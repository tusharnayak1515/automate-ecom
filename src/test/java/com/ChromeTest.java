...
public class ChromeTest extends DemoTest {
	...
	{			
		try {
			...
			String filename = "OpenFlipkart - " + "Chrome" + ".jpg";
			String screenshotpath = captureScreenShot(filename);
			extentTest.addScreenCaptureFromPath(screenshotpath);
			
			Thread.sleep(2000);
			
			String filename1 = "CloseLoginPopup - " + "Chrome" + ".jpg";
	...
	{			
		try {
            ...
            String filename = "MobileCategory - " + "Chrome" + ".jpg";
			String screenshotpath = captureScreenShot(filename);
			extentTest.addScreenCaptureFromPath(screenshotpath);
	        ...
	        String filename1 = "SearchIphone - " + "Chrome" + ".jpg";
			String screenshotpath1 = captureScreenShot(filename1);
			extentTest.addScreenCaptureFromPath(screenshotpath1);
	...
	public void ProductImagesLoadedTest() {
		...
		String filename = "ProductImageLoad - " + "Chrome" + ".jpg";
		String screenshotpath = captureScreenShot(filename);
		extentTest.addScreenCaptureFromPath(screenshotpath);
	...
	public boolean isScrollFeatureAvailable() {
        try {
            ...
            String filename = "ScrollAvailable - " + "Chrome" + ".jpg";
			String screenshotpath = captureScreenShot(filename);
			extentTest.addScreenCaptureFromPath(screenshotpath);
            Thread.sleep(2000);
            return true;
